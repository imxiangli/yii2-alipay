...
class AlipayRSA
{
    ...
    public static function rsaSign($data, $private_key)
    {
        ...
        if ($res) {
            ...
            throw new ErrorException('您的私钥格式不正确! The format of your private_key is incorrect!');
        }
    ...
    public static function rsaVerify($data, $alipay_public_key, $sign)
    {
        ...
        if ($res) {
            ...
            throw new ErrorException('您的支付宝公钥格式不正确! The format of your alipay_public_key is incorrect!');
        }
        openssl_free_key($res);
        return $result;
    }
